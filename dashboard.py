...
st.set_page_config(
    page_title="MilhasPro | O Sistema do Milheiro Profissional",
    page_icon="🚀",
    layout="wide",
...
<style>
    ...
    .lp-icon { font-size: 3rem; margin-bottom: 15px; display: block; }
    .lp-title { font-weight: 700; color: #0E436B; margin-bottom: 10px; font-size: 1.2rem; }
    .lp-text { color: #666; font-size: 0.95rem; line-height: 1.5; }
...
def tela_landing_page():
    ...
    with c1:
        ...
        st.markdown("""
        # Transforme Milhas em Dinheiro Real. 🚀
        
        Pare de perder dinheiro vendendo na hora errada. O **MilhasPro** é a única plataforma que combina cotação automática com inteligência de mercado P2P.
        
        ✅ **Monitore** o preço da Hotmilhas 24/7.  
        ✅ **Descubra** o valor real nos Grupos de Telegram (P2P).  
        ✅ **Gerencie** seu estoque e saiba seu lucro exato.
        """)
        st.write("")
    
    with c2:
        # -- ÁREA DE LOGIN FLUTUANTE --
        st.markdown("<div style='background: white; padding: 20px; border-radius: 10px; box-shadow: 0 4px 20px rgba(0,0,0,0.1); border: 1px solid #eee;'>", unsafe_allow_html=True)
        st.markdown("<h3 style='text-align: center; color: #0E436B;'>Acessar Painel</h3>", unsafe_allow_html=True)
        
        tab_l, tab_c = st.tabs(["ENTRAR", "CRIAR CONTA GRATUITA"])
    ...
    # -- FEATURE CARDS --
    st.markdown("<h2 style='text-align: center; color: #444;'>Por que usar o MilhasPro?</h2><br>", unsafe_allow_html=True)
    ...
    with col_f1:
        ...
        <div class="lp-card">
            ...
            <div class="lp-title">Robô Automático</div>
            <div class="lp-text">Nosso sistema monitora a Hotmilhas todo dia às 07:00 da manhã e salva o histórico para você nunca perder o pico de venda.</div>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col_f2:
        ...
        <div class="lp-card">
            <span class="lp-icon">👥</span>
            <div class="lp-title">Radar P2P</div>
            <div class="lp-text">Saiba quanto estão pagando nos grupos fechados de Telegram. Compare o preço oficial x paralelo e venda mais caro.</div>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col_f3:
        ...
        <div class="lp-card">
            <span class="lp-icon">💼</span>
            <div class="lp-title">Carteira Inteligente</div>
            <div class="lp-text">Registre suas compras. O sistema calcula seu patrimônio atualizado baseado na MELHOR cotação do dia.</div>
        </div>
        """, unsafe_allow_html=True)
    ...
    with c_p1:
        st.info("### Plano FREE 🔹\n\n* ✅ Acesso ao Dashboard de Cotação\n* ✅ Gráficos de Histórico\n* ❌ Gestão de Carteira\n* ❌ Radar P2P\n* **GRÁTIS PARA SEMPRE**")
    
    with c_p2:
        st.success("### Plano PRO ⭐\n\n* ✅ **Tudo do Free**\n* ✅ **Gestão de Carteira Completa**\n* ✅ **Acesso ao Radar P2P**\n* ✅ **Suporte Prioritário**\n* **R$ 49,90 / mês**")
...
def sistema_logado():
    ...
    with st.sidebar:
        st.markdown(f"""<div style="display: flex; justify-content: center; margin-bottom: 15px;"><img src="{LOGO_URL}" style="width: 180px;"></div>""", unsafe_allow_html=True)
