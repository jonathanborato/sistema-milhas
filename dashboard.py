...
def sistema_logado():
    ...
    if menu == "Dashboard (Mercado)":
        ...
        st.caption("Dados atualizados automaticamente pelo robô (07:00 AM).")
        ...
        if not df_cotacoes.empty:
            ...
            st.warning("Aguardando execução automática do Robô.")
            st.info("O sistema coleta dados automaticamente. Se os dados não aparecerem, verifique o GitHub Actions.")
